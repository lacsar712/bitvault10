...
import (
	...
	"example.com/bitvault/internal/backup"
	"example.com/bitvault/internal/model"
	"example.com/bitvault/internal/policy"
	"example.com/bitvault/internal/report"
	"example.com/bitvault/internal/validate"
	"example.com/bitvault/internal/workflow"
)
...
func (s *Server) handleBackup(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Disposition", "attachment; filename=bitvault.zip")
	_, _ = w.Write(b)
}
